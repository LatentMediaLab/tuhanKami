...
ENTITY_VOICE_SETTINGS = VoiceSettings(
    stability=0.40,
...
def clone_voice(client: ElevenLabs, prayer_wav: str) -> str:
    ...
    entity_voice = client.text_to_voice.create(
        voice_name="entity_ritual_voice_remixed",
        voice_description=ENTITY_DESCRIPTION,
...
def speak(client: ElevenLabs, voice_id: str, text: str) -> bytes:
    chunks = client.text_to_speech.convert(
        ...
        voice_settings=ENTITY_VOICE_SETTINGS,
    )
